...
const ProductCard = ({ prod }) => {
    return (
        <Link href={`/product/${prod.id}`} key={prod.title} className="mx-auto mt-11 w-36 md:w-48 xl:w-72 transform overflow-hidden shadow-md duration-300 hover:scale-105">
